                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_right">
                            <h3>Layanan Perubahan Status Mushola Menjadi Masjid</h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <?php echo form_open_multipart('umum/tambah_ubah_status_mushola'); ?>
                                    <span class="section">Form Persyaratan Layanan</span>
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 mx-5"><h6>Alamat Mushola</h6><span class="required"></span></label>
                                            <div class="col-md-8 col-sm-6">
                                        ...
                                        <div class="row justify-content-center mx-auto">
                                            ...
                                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" required='required'><span class="required"></span>
